# Morelord Core release script - based on the proven Morelord Marketplace workflow
[CmdletBinding()]
param(
...
$ModuleId = "morelord-core"
$ModuleTitle = "Morelord Core"
$GitHubOwner = "tmoreland72"
$GitHubRepo = "morelord-core"
$ReleaseBranch = "main"
...
function Assert-Manifest {
    ...
    if ($MinimumCompatibility -lt 13) {
        throw "$ModuleTitle must require Foundry VTT v13 or later."
    }
}
